...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Consultency API',
    'DESCRIPTION': 'API for dynamic site content (CMS, services, projects, sectors, team, testimonials).',
    'VERSION': '1.0.0',
}
...
DEFAULT_FROM_EMAIL = 'no-reply@consultency.local'
